#Enable to work with a CSV file easier
import pandas as pd
import csv 
...
def add():
    CSV.initialize_csv()
    date = get_date("Enter the date of the transacton(dd-mm-yyyy) or enter for today's date:", allow_default=True)
    amount = get_amount()
...
def main():
    while True:
        ...
        if choice == "1":
            ...
            print("Invalide choice. Enter 1, 2 or 3.")
